...
from utils import genotypes_m as genotypes
from models.darts_cnn_m import NetworkImageNet as Network
# import models
...
def main(args):
    ...
    linear_scaled_lr = args.lr * args.batch_size * util.get_world_size() / 512.0
    ...
    if args.resume:
        ...
        if not args.eval and 'optimizer' in checkpoint and 'lr_scheduler' in checkpoint and 'epoch' in checkpoint:
            ...
            if False: # args.model_ema:
                util._load_checkpoint_for_ema(model_ema, checkpoint['model_ema'])
