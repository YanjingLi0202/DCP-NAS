...
from models import darts_ops_x_ori as ops # _ori
...
DDPNAS_XNOR_A_2 = Genotype(
    ...
    reduce=[
        ...
        [('dil_conv_3x3', 1), ('sep_conv_3x3', 0)],
        [('sep_conv_5x5', 3), ('avg_pool_3x3', 1)]],
    reduce_concat=range(2, 6))

PCDARTS_XNOR_A_3 = Genotype(
    normal=[
        ('sep_conv_3x3', 1), ('sep_conv_5x5', 0),
...
genotype_array = {
    ...
    'DDPNAS_XNOR_A_2': DDPNAS_XNOR_A_2,
