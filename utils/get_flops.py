    ...
    ### ops_linear
        ...
        if 'bias' in type_name:
            ...
            delta_params = get_layer_param(layer)
                       ...
                       'AvgPool2d', 'MaxPool2d', 'Mask', 'ChannelSelectLayer', 'LambdaLayer', 'Sequential', 'ReLU6',
                       'hswish', 'hsigmoid', 'Identity', 'Normalize', 'Sigmoid']:
        return 
    ### unknown layer type
    else:
...
def measure_model(model, C, H, W):
    ...
    print(count_ops/1e6, count_params/1e6)
