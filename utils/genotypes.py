...
def parse_numpy(alpha, k):
    ...
    for edges in alpha:
        # edges: Tensor(n_edges, n_ops)
        # edge_max, primitive_indices = torch.topk(torch.tensor(edges), 1) # ignore 'none'
...
DDPNAS_6 = Genotype(
    ...
    reduce=[
        ...
        [('sep_conv_3x3', 0), ('skip_connect', 2)],
        [('dil_conv_3x3', 3), ('avg_pool_3x3', 1)],
        [('max_pool_3x3', 4), ('sep_conv_5x5', 0)]],
    reduce_concat=range(2, 6))
...
DDPNAS_PLANT_300M_1 = Genotype(
    normal=[
        [('skip_connect', 1), ('skip_connect', 0)],
        [('avg_pool_3x3', 2), ('dil_conv_3x3', 1)],
    ...
    reduce=[
        ...
        [('avg_pool_3x3', 3), ('dil_conv_5x5', 0)],
        [('sep_conv_5x5', 4), ('dil_conv_5x5', 1)]],
    reduce_concat=range(2, 6))
...
BANDIT_4 = Genotype(
    ...
    reduce=[
        ...
        [('dil_conv_5x5', 1), ('avg_pool_3x3', 4)]],
    reduce_concat=range(2, 6))

BANDIT_5 = Genotype(
    normal=[
        [('avg_pool_3x3', 1), ('sep_conv_3x3', 0)],
        [('dil_conv_5x5', 2), ('avg_pool_3x3', 1)],
        [('sep_conv_5x5', 1), ('sep_conv_5x5', 0)],
        [('sep_conv_5x5', 3), ('skip_connect', 2)]],
    normal_concat=range(2, 6),
    reduce=[
        [('sep_conv_5x5', 1), ('sep_conv_5x5', 0)],
        [('max_pool_3x3', 2), ('sep_conv_3x3', 1)],
...
BANDIT_10 = Genotype(
    normal=[
        ...
        [('dil_conv_5x5', 3), ('avg_pool_3x3', 2)]],
    normal_concat=range(2, 6),
    reduce=[
        [('dil_conv_3x3', 0), ('dil_conv_3x3', 1)],
        [('max_pool_3x3', 1), ('sep_conv_3x3', 0)],
        [('dil_conv_5x5', 1), ('sep_conv_5x5', 3)],
        [('sep_conv_5x5', 0), ('sep_conv_3x3', 1)]],
    reduce_concat=range(2, 6))
...
BANDIT_18 = Genotype(
    normal=[
        [('avg_pool_3x3', 0), ('sep_conv_5x5', 1)],
        [('sep_conv_3x3', 1), ('max_pool_3x3', 0)],
        [('avg_pool_3x3', 3), ('sep_conv_3x3', 0)],
        [('dil_conv_3x3', 3), ('max_pool_3x3', 2)]],
    normal_concat=range(2, 6),
    reduce=[
        [('avg_pool_3x3', 0), ('dil_conv_5x5', 1)],
        [('max_pool_3x3', 2), ('avg_pool_3x3', 0)],
...
genotype_array = {
    ...
    "BNAS_XNOR_1": BNAS_XNOR_1,
    "DDPNAS_XNOR_1": DDPNAS_XNOR_1,
    "DDPNAS_MCN_IMAGENET_1": DDPNAS_MCN_IMAGENET_1,
    'PC_DARTS_cifar': PC_DARTS_cifar,
    'PC_DARTS_image': PC_DARTS_image,
    'DDP_PR_1': DDP_PR_1,
    'DDP_PRA_1': DDP_PRA_1,
    'DARTS_V1': DARTS_V1,
    'DARTS_V2': DARTS_V2,
